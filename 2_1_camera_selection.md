...
![](https://www.kyocera.co.jp/newsroom/news/img/b89a75ca70bbe7ddb083d2d74c351543.jpg)
「一つのセンサーに二つのレンズを搭載した独自のステレオカメラ構成を採用することにより、従来のステレオカメラでは不可能な超近距離センシングを可能としました」
![](https://www.kyocera.co.jp/newsroom/news/img/4a5fc86d5a4092f9304fe968388ed406.jpg)

## 仮説： NDAがちがちのカメラ・カメラSDKは、未来を切り開くことができない。
### 従来型のNDAガチガチの状況
- 購入までの障害が多い
- NDAを結ばないと、利用できない。
- サンプルコードが公開されていない。
...
### どういう具合に自壊してしまうか
- 参考例：Visconti チップの自壊
  - 従来型の大口顧客だけに期待する営業スタイルは、特定のユースケースだけにしか、顧客を確保できなかった。
  - しかも、その大口顧客にとってはone of them（選択肢の１つ）の状況をであって、主力の選択肢にはならなかった。
  - 深層学習前の時代のアルゴリズムは、YOLOのような物体検出に比べ無駄が多く、汎用の深層学習が可能な状況に対して、優位性を失ってしまった。
  - 顧客は、特定の技術が、置き換え可能性をもっていない場合、警戒してしまう。
    - 供給価格・供給数量、これらが全て供給者に握られていることを怯える。
  - これらの技術が、生鮮食料品のように消費期限があることを理解していなかったのではなかろうか。
- 参考例：某社システムLSI
  - デジタル製品の根幹が、どのようなIPコアをもったシステムLSIを搭載するかにかかっている。
  - そう判断してシステムLSIを進めていったのは正しいと思う。
  - しかし、問題は、そのシステムLSIを世界で売れる商材に仕上げようとしなかったことだ。
  - カメラ画像処理を行うシステムLSIに顔検出機能が搭載されていたものもあったのに、カタログにはその記載もしなかった。
  - そのことは、顔検出機能を含めて画像認識処理の高い性能を持つ画像システムLSI製品の市場を、他社のために残しておいたことになった。
  - Ambarela などの会社が、その位置を占めることになった。

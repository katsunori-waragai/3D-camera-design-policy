...
## 直前フレームの情報によって,現フレームでの処理内容を制限する。
- 人検出のハードウェアの処理の負荷を不要なときには減らしたいのであれば、差分画像を生じないときには、人検出を行わないという選択肢がある。
- あるいは、人追跡における次のような工夫もある。
  - 追跡開始時に想定するpixel サイズ
  - 人追跡打ち切り時に想定するpixelサイズ
  - この２つを区別することで、小さすぎて検出できないサイズまでの人追跡が可能になる。
...
- 値をキャッシュしておくことで、処理の内容が削減できるなら、キャッシュすることでの高速化を実現する。
#### 大半がROS2がしていることじゃないか
